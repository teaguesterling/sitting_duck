...
public:
	...
	uint64_t ComputeSemanticId(TSNode node, const string &content, uint64_t parent_hash = 0) const;
...
protected:
	...
	void SetParserLanguageWithValidation(TSParser *parser, const TSLanguage *language,
