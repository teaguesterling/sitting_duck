...
void StructuredASTNode::populate_from_legacy(const ASTNode &legacy_node, ContextLevel context_level,
                                             LocationLevel location_level, StructureLevel structure_level) {
	// Core fields
