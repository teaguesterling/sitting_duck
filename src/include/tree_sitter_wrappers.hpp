...
public:
    ...
    TSParser* get() const { return parser_.get(); }
    TSParser* operator->() const { return parser_.get(); }
    ...
    void SetLanguage(const TSLanguage* language, const string& language_name) {
        ...
        if (language_version < TREE_SITTER_MIN_COMPATIBLE_LANGUAGE_VERSION ||
            ...
            throw InternalException(
                "Incompatible language version for " + language_name + 
...
public:
    ...
    TSTree* get() const { return tree_.get(); }
