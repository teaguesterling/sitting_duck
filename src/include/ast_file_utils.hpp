...
public:
	 ...
	 */
	static vector<string> GetFiles(ClientContext &context, const Value &path_value, bool ignore_errors = false,
	 ...
	 */
	static vector<string> GetFiles(ClientContext &context, const vector<string> &patterns, bool ignore_errors = false,
	                               const vector<string> &supported_extensions = {});
