...
string ZigAdapter::ExtractNodeValue(TSNode node, const string &content) const {
    ...
    if (node_type == "integer" || node_type == "float" || node_type == "string" ||
        node_type == "multiline_string" || node_type == "character" || 
        node_type == "boolean" || node_type == "null" || node_type == "undefined") {
