...
7,float,5,test/data/r/simple.R,r,5,6,5,7,4,2,2,0,0,5,64,0,0
...
11,float,10,test/data/r/simple.R,r,6,5,6,7,8,2,2,0,0,10,64,0,0
...
15,float,15,test/data/r/simple.R,r,7,7,7,9,12,2,2,0,0,15,64,0,0
...
22,parameters,,test/data/r/simple.R,r,10,27,10,49,20,3,1,5,9,"(values, na.rm = TRUE)",180,0,4
23,(,,test/data/r/simple.R,r,10,27,10,28,22,4,0,0,0,(,4,0,0
24,parameter,values,test/data/r/simple.R,r,10,28,10,34,22,4,1,1,1,values,244,0,1
...
27,parameter,na.rm,test/data/r/simple.R,r,10,36,10,48,22,4,3,3,3,na.rm = TRUE,244,0,3
...
46,arguments,,test/data/r/simple.R,r,12,25,12,41,44,8,1,3,12,[!is.na(values)],180,0,3
...
53,arguments,,test/data/r/simple.R,r,12,32,12,40,51,12,1,3,4,(values),180,0,3
...
62,arguments,,test/data/r/simple.R,r,14,11,14,41,60,5,1,3,19,(sum(values) / length(values)),180,0,3
...
68,arguments,,test/data/r/simple.R,r,14,15,14,23,66,9,1,3,4,(values),180,0,3
...
76,arguments,,test/data/r/simple.R,r,14,32,14,40,74,9,1,3,4,(values),180,0,3
...
89,arguments,,test/data/r/simple.R,r,18,15,18,30,87,3,1,11,16,"(1, 2, 3, 4, 5)",180,0,6
...
92,float,1,test/data/r/simple.R,r,18,16,18,17,91,5,0,0,0,1,64,0,0
...
95,float,2,test/data/r/simple.R,r,18,19,18,20,94,5,0,0,0,2,64,0,0
...
98,float,3,test/data/r/simple.R,r,18,22,18,23,97,5,0,0,0,3,64,0,0
...
101,float,4,test/data/r/simple.R,r,18,25,18,26,100,5,0,0,0,4,64,0,0
...
104,float,5,test/data/r/simple.R,r,18,28,18,29,103,5,0,0,0,5,64,0,0
...
138,float,1,test/data/r/simple.R,r,26,11,26,12,137,3,0,0,0,1,64,0,0
139,:,,test/data/r/simple.R,r,26,12,26,13,137,3,1,0,0,:,192,0,0
140,float,10,test/data/r/simple.R,r,26,13,26,15,137,3,2,0,0,10,64,0,0
...
151,float,2,test/data/r/simple.R,r,27,14,27,15,148,6,2,0,0,2,64,0,0
152,==,,test/data/r/simple.R,r,27,16,27,18,147,5,1,0,0,==,200,0,0
153,float,0,test/data/r/simple.R,r,27,19,27,20,147,5,2,0,0,0,64,0,0
...
159,arguments,,test/data/r/simple.R,r,28,14,28,33,157,6,1,3,16,"(paste(""Even:"", i))",180,0,3
...
164,arguments,,test/data/r/simple.R,r,28,20,28,32,162,9,1,5,10,"(""Even:"", i)",180,0,4
...
182,arguments,,test/data/r/simple.R,r,30,14,30,32,180,6,1,3,16,"(paste(""Odd:"", i))",180,0,3
...
187,arguments,,test/data/r/simple.R,r,30,20,30,31,185,9,1,5,10,"(""Odd:"", i)",180,0,4
...
205,float,1,test/data/r/simple.R,r,35,12,35,13,202,2,2,0,0,1,64,0,0
...
212,float,5,test/data/r/simple.R,r,36,19,36,20,209,3,2,0,0,5,64,0,0
...
218,arguments,,test/data/r/simple.R,r,37,10,37,19,216,4,1,3,4,(counter),180,0,3
...
229,float,1,test/data/r/simple.R,r,38,26,38,27,226,5,2,0,0,1,64,0,0
...
237,arguments,,test/data/r/simple.R,r,42,25,42,36,235,3,1,3,4,(my_vector),180,0,3
...
244,arguments,,test/data/r/simple.R,r,43,8,43,17,242,2,1,3,4,(my_list),180,0,3
...
255,arguments,,test/data/r/simple.R,r,46,24,46,42,253,3,1,5,10,"(mtcars, mpg > 20)",180,0,4
...
264,float,20,test/data/r/simple.R,r,46,39,46,41,261,6,2,0,0,20,64,0,0
...
271,arguments,,test/data/r/simple.R,r,47,24,47,62,269,3,1,7,17,"(mpg ~ cyl, data = mtcars, FUN = mean)",180,0,5
...
299,arguments,,test/data/r/simple.R,r,51,11,51,21,297,5,1,3,7,(mpg > 20),180,0,3
...
305,float,20,test/data/r/simple.R,r,51,18,51,20,302,8,2,0,0,20,64,0,0
...
310,arguments,,test/data/r/simple.R,r,52,14,52,47,308,4,1,7,17,"(mpg ~ cyl, data = ., FUN = mean)",180,0,5
...
342,float,1,test/data/r/simple.R,r,57,19,57,20,341,3,0,0,0,1,64,0,0
343,+,,test/data/r/simple.R,r,57,21,57,22,341,3,1,0,0,+,192,0,0
344,complex,2i,test/data/r/simple.R,r,57,23,57,25,341,3,2,1,1,2i,64,0,1
...
354,parameters,,test/data/r/simple.R,r,63,28,63,31,352,3,1,3,4,(x),180,0,3
355,(,,test/data/r/simple.R,r,63,28,63,29,354,4,0,0,0,(,4,0,0
356,parameter,x,test/data/r/simple.R,r,63,29,63,30,354,4,1,1,1,x,244,0,1
...
363,arguments,,test/data/r/simple.R,r,64,11,64,18,361,5,1,3,7,(x * 2),180,0,3
...
369,float,2,test/data/r/simple.R,r,64,16,64,17,366,8,2,0,0,2,64,0,0
...
375,arguments,,test/data/r/simple.R,r,68,8,68,15,373,2,1,3,4,(dplyr),180,0,3
